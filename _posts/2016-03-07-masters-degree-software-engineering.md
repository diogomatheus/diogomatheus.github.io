...
---
Conforme compartilhei recentemente na publicação sobre mudanças, em 2015 concentrei meus esforços nos estudos, investindo em tecnologias emergentes, bem como em gestão e gerenciamento de projetos. Dessa forma, meu principal objetivo era reduzir o ritmo de produção e refletir um pouco mais sobre os métodos que eu estava usando para desenvolver projetos de software. Além de colocar os estudos em dia, aproveitei para criar aplicações e obter certificados ao longo do percurso.

Nesse cenário, no final de 2015 após encerrar um ciclo de exames de certificação (e.g., PMP, ITIL), me inscrevi no processo seletivo de mestrado do Programa de Engenharia de Sistemas e Computação (PESC), oferecido pela COPPE/UFRJ. Após realizar algumas etapas, fui aprovado e irei compartilhar um pouco dessa experiência com vocês.
...
- [http://www.cos.ufrj.br/selecao/?page_id=2&lang=pt](http://www.cos.ufrj.br/selecao/?page_id=2&lang=pt)
- [http://posgraduando.com/guia-pos-graduacao/](http://posgraduando.com/guia-pos-graduacao/)