...
---
jQuery é uma biblioteca JavaScript de código aberto criada por [John Resig](https://johnresig.com/). Trata-se de uma biblioteca baseada na licença GPL (General Public Licence), ou seja, pode ser usada em projetos pessoais e comerciais.
